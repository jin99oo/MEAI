/*:
* @plugindesc v.1.3.7 [MZ] Advanced project testing and various settings. Made with ♥ by DKPlugins
* @author DKPlugins
...
/*:ru
* @plugindesc v.1.3.7 [MZ] Расширенное тестирование проекта и различные настройки. Сделано с ♥ от DKPlugins
* @author DKPlugins
* @url https://dk-plugins.ru
* @target MZ
* @help
...
Object.defineProperties(DKTools, {
     ...
     * @memberof DKTools
     */
    PATREON: { value: 'https://patreon.com/dkplugins' },

    /**
     * DKPlugins Boosty site
     * @since 1.3.7
     * @constant
     * @type {String}
     * @memberof DKTools
     */
    BOOSTY: { value: 'https://boosty.to/dkplugins' },
...
DKTools.Utils = class {
    ...
    static async _checkUpdates() {
        ...
        try {
            ...
            plugins = await DKTools.Network.fetchJson(`https://tools.dk-plugins.ru/plugins.php?${queryParams}`) || [];
...
Scene_Map.prototype._setupMapPreloading = function() {
    ...
    preset['Audio Files'].forEach((path) => {
        DKTools.PreloadManager.preloadAudio({ path: AudioManager._path + path });
    });
